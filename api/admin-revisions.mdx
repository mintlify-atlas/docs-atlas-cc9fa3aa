---
title: "Admin Revision History — GET Location Revisions Endpoint"
sidebarTitle: "Admin Revisions"
description: "JWT-protected GET /api/admin/locations/{id}/revisions returns all revision records for a location sorted by date_time_revision descending (newest first)."
---
