---
title: "Admin Login — POST /api/login API Endpoint Reference"
sidebarTitle: "Admin Login"
description: "Authenticate as an admin user with POST /api/login. Submit name and password to receive a signed JWT access token for all protected admin endpoints."
---
