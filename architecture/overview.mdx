---
title: "System Architecture of Goods Inventory"
sidebarTitle: "Overview"
description: "Explore how the React frontend, Flask REST API, and MySQL database are structured and communicate in the Goods Inventory system."
---
...
| `GET` | `/api/revisiones` | List revision records |
...
| `PUT` / `DELETE` | `/api/admin/items/{id}` | Modify or remove an item |
| `GET` / `POST` | `/api/admin/locations/{id}/revisions` | List or create revisions for a location |
