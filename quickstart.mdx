---
title: "Goods Inventory Quickstart: Backend and Frontend Setup"
...
<Steps>
  ...
  <Step title="Set up the React frontend">
    ...
    Vite exposes this value to the application as `import.meta.env.VITE_API_URL`. The `src/config/api.js` file re-exports it as `API_URL`, which every component imports when making `fetch` calls to the Flask backend.
