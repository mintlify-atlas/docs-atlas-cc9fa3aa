---
title: "Goods Inventory: What It Is and How It Works"
...
<CardGroup cols={2}>
  ...
  <Card title="React + Vite" icon="browser">
    The frontend is a **React 19** single-page application scaffolded with **Vite** for fast development and optimized production builds. It talks to the Flask API via `axios`, with the base URL configured through a Vite environment variable.
  </Card>
